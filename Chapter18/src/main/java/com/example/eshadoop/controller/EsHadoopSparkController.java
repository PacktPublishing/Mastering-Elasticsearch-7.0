package com.example.eshadoop.controller;
...
import com.example.eshadoop.service.impl.EsHadoopSparkService;
...
public class EsHadoopSparkController {
	...
	@Autowired
	private EsHadoopSparkService sparkClient;
	...
	public ResponseEntity<Map<String, Object>> searchRequest(
			...
			@RequestParam(value = "numOfClass") int numOfClass) throws Exception {
				Map<String,Object> response = sparkClient.buildAnomalyDetectionModel(indexName, fieldNames, numOfClass);
