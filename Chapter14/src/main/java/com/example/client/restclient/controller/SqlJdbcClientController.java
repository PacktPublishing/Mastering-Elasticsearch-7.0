...
public class SqlJdbcClientController {
	...
	@ApiImplicitParams({
		@ApiImplicitParam(paramType = "query", name="url", type="String", required=false, defaultValue="/"),
	...
	public ResponseEntity<Map<String, Object>> executeQuery(
			...
			@RequestParam(value = "sqlStatement") String sqlStatement) throws Exception {
				Map<String,Object> response = sqlJdbcClient.executeQuery(url, sqlStatement);
